...
{
    public partial class frmReportPaymentProoflist : MetroForm
    {
        public frmReportPaymentProoflist()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<rptPaymentProoflist> rptCollectionProoflistList = glBal.getPaymentProoflist(dtDateFrom.Value.ToString("MM/dd/yyyy"), dtDateTo.Value.ToString("MM/dd/yyyy"));
                reportViewer1.LocalReport.DataSources.Clear(); //clear report

                reportViewer1.LocalReport.ReportEmbeddedResource = "GeneralLedger.Report.RDLC.PaymentProoflist.rdlc"; // bind reportviewer with .rdlc
