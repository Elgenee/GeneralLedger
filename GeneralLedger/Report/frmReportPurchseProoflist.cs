...
{
    public partial class frmReportPurchseProoflist : MetroForm
    {
        public frmReportPurchseProoflist()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<rptPurchaseProoflist> rptSalesProoflistList = glBal.getPurchaseProoflist(dtDateFrom.Value.ToString("MM/dd/yyyy"), dtDateTo.Value.ToString("MM/dd/yyyy"));
                reportViewer1.LocalReport.DataSources.Clear(); //clear report

                reportViewer1.LocalReport.ReportEmbeddedResource = "GeneralLedger.Report.RDLC.PurchaseProoflist.rdlc"; // bind reportviewer with .rdlc
                Microsoft.Reporting.WinForms.ReportDataSource dsJournalProoflistList = new Microsoft.Reporting.WinForms.ReportDataSource("dsRPTJournalProoflist", rptSalesProoflistList); // set the datasource
