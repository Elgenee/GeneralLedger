...
{
    public partial class frmReportSaleProoflist : MetroForm
    {
        public frmReportSaleProoflist()
        {
            InitializeComponent();
        }
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<rptJournalProoflist> rptSalesProoflistList = glBal.getSalesEntryProoflist(dtDateFrom.Value.ToString("MM/dd/yyyy"), dtDateTo.Value.ToString("MM/dd/yyyy"));
                reportViewer1.LocalReport.DataSources.Clear(); //clear report

                reportViewer1.LocalReport.ReportEmbeddedResource = "GeneralLedger.Report.RDLC.SalesProoflist.rdlc"; // bind reportviewer with .rdlc
