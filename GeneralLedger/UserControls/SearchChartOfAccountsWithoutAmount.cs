...
{
    public partial class SearchChartOfAccountsWithoutAmount : MetroForm
    {
        ...
        public SearchChartOfAccountsWithoutAmount()
        {
            InitializeComponent();
            GLTranDetail = null;
            this.intIDMasCOA = 0;
        ...
        private void btnSearchChartOfAccounts_Click_1(object sender, EventArgs e)
        {
