        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (res == DialogResult.OK)
                {
                    ...
                    //this.txtPaymentID.Text = sje.AccountReceivableAdjustment.CollectionId.ToString();
                    ////this.SaleId = (int)sje.AccountReceivableAdjustment.SalesId;
                    //this.txtPurchaseTransactionNO.Text = sje.AccountReceivableAdjustment.Collection.Sale.TRANo;
                    //this.txtSupplier.Text = sje.AccountReceivableAdjustment.Collection.Sale.Customer.strName;
                    //this.txtPaymentCV.Text = sje.AccountReceivableAdjustment.Collection.TRANo.ToString();
