...
{
    public partial class frmAccountPayableAdjustmentDebitCreditMemo : MetroUserControl
    {
        ...
        public frmAccountPayableAdjustmentDebitCreditMemo()
        {
        ...
        private void btnSearchSale_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (res == DialogResult.OK)
                {
                    ...
                    //this.txtSupplierId.Text = sp.Payment.Id.ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (TransType.Equals("insert"))
                {
                    ...
                    AccountPayableAdjustment = AccountsPayableAdjustmentsServices.AddDebitCreditMemo(AccountPayableAdjustment, this.GLTranDetail, this.chkUseDefaultEntry.Checked);
                ...
                else
                {
                    ...
                    AccountPayableAdjustment = AccountsPayableAdjustmentsServices.UpdateDebitCreditMemo(AccountPayableAdjustment, this.GLTranDetail, this.chkUseDefaultEntry.Checked);
                    if (AccountPayableAdjustment != null)
                    {
                        MessageBox.Show("Successfully saved");
                    }
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            try
            {
                SearchAdjustmentAccountPayableAdjustmentsDebitCreditMemo spe = new SearchAdjustmentAccountPayableAdjustmentsDebitCreditMemo();
                spe.BringToFront();
                spe.TopMost = true;
                var adjustmentType = (this.cbAdjustmentType.SelectedItem == null) ? 0 : ((AccountsPayableAdjustmentsType)this.cbAdjustmentType.SelectedItem).Id;
                spe.intIdAccountsPayableAdjustmentType = adjustmentType;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (TransType.Equals("delete"))
                {
                    ...
                    AccountsPayableAdjustmentsServices.RemoveDebitCreditMemo(AccountPayableAdjustment);
