...
namespace GeneralLedger.UserControls
{
    ...
    public partial class frmChooseReturnSaleProduct : MetroForm
    {
        ...
        public frmChooseReturnSaleProduct()
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductBAL productBAL = new ProductBAL();
                var productListOld = productBAL.getReturnSalesProductSearch(this.txtCriteria.Text, this.SalesID);
