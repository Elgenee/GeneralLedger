                ...
                if (res == DialogResult.OK)
                {
                    ...
                    if (AccountPayableAdjustmentsDetailList.Count > 0)
                    {
                        ...
                        for (int i = 0; i < AccountPayableAdjustmentsDetailList.Count; i++)
                        {
                            ...
                            var product = accountPayableAdjustmentsDetail.Product;
                            ...
                            this.dgProduct.Rows[i].Cells[27].Value = accountPayableAdjustmentsDetail.UnitPrice ?? 0;
                            this.dgProduct.Rows[i].Cells[28].Value = accountPayableAdjustmentsDetail.Quantity ?? 0;
                            this.dgProduct.Rows[i].Cells[29].Value = accountPayableAdjustmentsDetail.TotalPrice ?? 0;
