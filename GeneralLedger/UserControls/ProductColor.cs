...
{
    public partial class ProductColor : MetroUserControl
    {
        ...
        private void ProductColor_Load(object sender, EventArgs e)
        {
            RefreshGrid();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ProductColorBAL ProductColorBAL = new ProductColorBAL();
                string result = ProductColorBAL.Manage(param, TransType);
        ...
        private void dgProductColor_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            
            if (e.RowIndex >= 0)
            {

                this.ID = Convert.ToInt32(dgProductColor.Rows[e.RowIndex].Cells[0].Value.ToString());
                this.txtID.Text = dgProductColor.Rows[e.RowIndex].Cells[0].Value.ToString();
                this.txName.Text = dgProductColor.Rows[e.RowIndex].Cells[1].Value.ToString();
            }
        }
