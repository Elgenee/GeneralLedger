...
namespace GeneralLedger.UserControls
{
    ...
    public partial class frmChooseReturnPurchaseProduct : MetroForm
    {
        ...
        public frmChooseReturnPurchaseProduct()
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ProductBAL productBAL = new ProductBAL();
                var productListOld = productBAL.getReturnPurchaseProductSearch(this.txtCriteria.Text, this.PurchaseID);
